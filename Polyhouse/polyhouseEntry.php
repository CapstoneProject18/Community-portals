<?php
	...
	$queryPolyhouse = "SELECT * FROM `polyhouse` ORDER BY sno DESC";
	...
	if(isset($_POST['submit'])) {
		...
		if(!empty($sno) & $sno > 0) {
			...
			$query = "INSERT INTO `polyhouse` (Sno, Date, Location, Crop, Variety, Trf_Qty, Mortality, Trf_Location, Net_Qty) VALUES (".$sno.", ".$date.", ".$location.", "
					.$crop.", ".$variety.", ".$trfQty.", ".$mortality.", ".$trfLocation.", ".$netQty.")";
...
<html>
	...
	<title>Polyhouse Entry</title>
	
	<link rel="stylesheet" type="text/css" href="polyhouseEntry.css">
	...
	<body>
		...
		<script type="text/javascript" src="polyhouseEntry.js"></script>
