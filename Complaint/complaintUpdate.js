...
function rowNumber(x) {
	...
	var noOfColumns = document.getElementById("complaintTable").rows[0].cells.length
	
	for(var i = 0; i < noOfColumns; i++) {
		
		var cellData = document.getElementById("complaintTable").rows[rowNo].cells[i].innerHTML;
