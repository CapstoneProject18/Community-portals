...
function rowNumber(x) {
	...
	var noOfColumns = document.getElementById("inventoryTable").rows[0].cells.length
	
	for(var i = 0; i < noOfColumns; i++) {
		
		var cellData = document.getElementById("inventoryTable").rows[rowNo].cells[i].innerHTML;
